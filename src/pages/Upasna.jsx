...
const Upasna = () => {
  ...
  const handleSharePhotos = () => {
    alert("Please share your photos with us at photos@ramandsita.com");
  };

  return (
    <div className="min-h-screen bg-[#FCF7F8] relative overflow-hidden font-sans">
      {/* Particle Background */}
      ...
      <div className="relative z-10">
        ...
        <section className="py-8 mx-4">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="relative">
              {/* Event Card */}
              <div className="bg-white/30 backdrop-blur-md p-4 rounded-lg border border-white/20 hover:shadow-lg transition-all min-h-[230px]">
        ...
        <section className="py-12 mx-4">
          <div className="max-w-md mx-auto bg-white/30 backdrop-blur-md p-8 rounded-xl shadow-lg border border-white/20 text-center">

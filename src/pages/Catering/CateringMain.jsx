...
<div className="sm:text-8xl text-4xl text-center text-[#4E8098] font-bold pt-4 sm:p-4"> CATERING </div>
<div className=" pt-4 sm:p-4 "> <img className="sm:w-44 w-44" src="https://i.ibb.co/t8qK9jf/c7.png"/></div>
</div>
<div className="text-center sm:text-6xl text-2xl font-bold mb-10 text-black">ＯＵＲ ＰＡＲＴＮＥＲＳ </div>
...
<div className="flex flex-col sm:flex-row justify-center p-2 sm:p-10 h-auto gap-10 pb-16">
 ...
 <img className="m-auto h-[70%] w-[90%] rounded-xl boxShadow " src={val.img} />

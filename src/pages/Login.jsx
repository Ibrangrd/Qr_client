          ...
          <div className="">
            <div className="flex ">
              ...
              <div className="md:mx-10 md:pt-36 md:px-32 px-10 md:w-1/2">
                <h1 className="text-5xl font-bold underline decoration-pink-600">
                  Login To Contact Us!
                </h1>
                <br />
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="flex justify-between align-bottom">
                    <button
                      type="submit"
                      className="btn btn-submit font-bold hover:bg-pink-600 hover:scale-110 duration-500 bg-pink-500 text-white"
                    >
                      Login
                    </button>
                    <div className="flex">
                      ...
                      <Link to="/register">
                        <p className="text-pink-500 font-bold">Register</p>
                      </Link>
                    </div>
                  </div>
                </form>

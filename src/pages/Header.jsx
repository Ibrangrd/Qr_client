...
const Header = ({ setTheme }) => {
  ...
  return (
    <div className="mb-[4.3rem] ">
      <nav className="bg-[#ffe7e7] dark:bg-gray-900 fixed w-full z-50 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
          ...
          <div className="flex gap-x-auto items-center md:order-2 pr-1">
            ...
            {isLoggedIn ? (
              <Link to="/logout">
                <button
                  type="button"
                  className="text-white bg-pink-500 hover:bg-pink-700 md:text-md hover:scale-105 duration-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                  Logout
                </button>
              </Link>

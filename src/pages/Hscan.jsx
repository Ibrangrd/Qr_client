...
const Hscan = ()=>{
  return(
    <>
     <div className="flex pl-6 bg-white gap-10 ">
     <img className="w-14 h-14 mt-[15%] -ml-2" src="https://iili.io/2CJKKbe.png" />
     <img className="w-36 h-36" src="https://i.ibb.co/wRmzy3p/o2.png" />
     <img className="w-14 h-14 mt-[15%] mr-4" src="https://iili.io/2CJKKbe.png" />
     </div>

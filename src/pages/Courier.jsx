  ...
  return (
    <div className="bg-white">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-1 sm:gap-16">
        <div className=" ml-16 sm:ml-32 "><img className=" w-[80%] sm:w-[100%] h-64 rounded-3xl sm:rounded-[30px] sm:h-80 p-1 sm:p-4 sm:ml-12 mt-5" src="https://storage.googleapis.com/my-website-image/ExtraPhotos/C.jpg" /></div>
